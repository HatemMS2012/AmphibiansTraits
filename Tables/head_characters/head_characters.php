...
function __import__csv(&$data, $defaultValues=array()){
    ...
    foreach ( $rows as $row ){
        ...
        list($Id, $head_length,$head_width,$snout_length,$internarial_distance,$nostril_to_snout_distance,$eye_to_nostril,
		$maximum_tympanum_diameter,$eye_length,$distance_between_front_of_eyes,$distance_between_behind_of_eyes,$interorbital_distance,$snout_shape_lateral,
		$snout_shape_dorsal,$interorbital_shape,$pineal_oscilusk,$loreal_region_shape,$canthus_rostralis,$nostril_shape,$tympanum_shape) = explode(';', $row);
        ...
        $head_characters->setValues(
            array(
				...
				'pineal_oscilusk'=>trim($pineal_oscilusk),
