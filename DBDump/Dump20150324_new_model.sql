...
CREATE TABLE `bodysize` (
  ...
  PRIMARY KEY (`tableID`),
  KEY `bsFK_idx` (`id`),
  CONSTRAINT `bsFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `bodysize` VALUES (1,'1',NULL,23.9,NULL,NULL,35.3,NULL,NULL,NULL),(2,'10',NULL,25.2,NULL,NULL,NULL,NULL,NULL,NULL),(3,'11',NULL,32.5,49,NULL,NULL,NULL,NULL,NULL),(4,'2',NULL,18.3,NULL,NULL,26.1,NULL,NULL,NULL),(5,'3',1000,3000,NULL,NULL,NULL,NULL,NULL,NULL),(6,'4',19.3,19.3,NULL,NULL,NULL,NULL,NULL,NULL),(7,'5',NULL,35,25.5,NULL,NULL,NULL,NULL,NULL),(8,'6',NULL,37,33.5,NULL,NULL,NULL,NULL,NULL),(9,'7',NULL,22.9,20.5,NULL,NULL,NULL,NULL,NULL),(10,'8',NULL,45,70,NULL,NULL,NULL,NULL,NULL),(11,'9',NULL,21.5,NULL,NULL,NULL,NULL,NULL,NULL),(12,'1',4,12,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `call_parameters` (
  ...
  PRIMARY KEY (`tableID`),
  KEY `cpFK_idx` (`id`),
  CONSTRAINT `cpFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `call_parameters` VALUES (1,'1',532,532,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'U',NULL),(2,'1',5325,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `calling_behaviour` (
  ...
  PRIMARY KEY (`tableID`),
  KEY `cbFK_idx` (`id`),
  CONSTRAINT `cbFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `calling_behaviour` VALUES (1,'1','fsda',NULL,'ATWATER',NULL,NULL,NULL,NULL),(2,'1','gsda',NULL,NULL,'ABSENT','EXPOSED',NULL,NULL);
...
INSERT INTO `climate` VALUES (1,'1',1,44,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `colouration` (
  ...
  PRIMARY KEY (`tableID`),
  KEY `colorFK_idx` (`id`),
  CONSTRAINT `colorFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `colouration` VALUES (1,'1','stripes','aposematic','none','polymorph','NY',NULL),(2,'10',NULL,NULL,NULL,NULL,NULL,NULL),(3,'11',NULL,NULL,NULL,NULL,NULL,NULL),(4,'2','points','aposematic','none','few','NY',NULL),(5,'3',NULL,NULL,NULL,NULL,NULL,NULL),(6,'4',NULL,NULL,NULL,NULL,NULL,NULL),(7,'5',NULL,NULL,NULL,NULL,NULL,NULL),(8,'6',NULL,NULL,NULL,NULL,NULL,NULL),(9,'7',NULL,NULL,NULL,NULL,NULL,NULL),(10,'8',NULL,NULL,NULL,NULL,NULL,NULL),(11,'9',NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `dataface__mtimes` VALUES ('bodysize',1427277354),('calling_behaviour',1427277577),('call_parameters',1427277461),('climate',1427278623),('colouration',1427208812),('dataface__failed_logins',1427210913),('dataface__htmlreports_reports',1427196493),('dataface__modules',1427196493),('dataface__mtimes',1427196493),('dataface__preferences',1427196500),('dataface__record_mtimes',1427196500),('dataface__version',1427196488),('distribution',1427277488),('egg_deposition',1427277825),('forlimb_characters',1427278716),('habitat_preference',1427278256),('head_characters',1427278583),('hindlimb_characters',1427278551),('misc',1427278641),('reference',1427212148),('taxonomic_identity',1427279035),('users',1427211113),('user_tracking',1427279034);
...
INSERT INTO `distribution` VALUES (1,'1','Africa',146696,NULL,'fragmented',270,1078,NULL),(2,'10','South east Asia',NULL,NULL,NULL,NULL,NULL,NULL),(3,'11','Africa',NULL,NULL,NULL,NULL,NULL,NULL),(4,'2','America',4478920,NULL,'continous',100,1300,NULL),(5,'3','Europe',NULL,NULL,NULL,NULL,NULL,NULL),(6,'4','North America',1,1,'continuos',NULL,NULL,NULL),(7,'5','North America',NULL,NULL,NULL,NULL,NULL,NULL),(8,'6','South east Asia',NULL,NULL,NULL,NULL,NULL,NULL),(9,'7','South America',NULL,NULL,NULL,NULL,NULL,NULL),(10,'8','South America',NULL,NULL,NULL,NULL,NULL,NULL),(11,'9','Madagascar',NULL,NULL,NULL,NULL,NULL,NULL),(12,'1','afsd',NULL,NULL,NULL,NULL,NULL,NULL),(13,'2','432',NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `egg_deposition` (
  ...
  PRIMARY KEY (`tableID`),
  KEY `eggFK_idx` (`id`),
  CONSTRAINT `eggFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `egg_deposition` VALUES (1,'1',5,11,'DISSECTIONS',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'1',42,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `forlimb_characters` (
  ...
  `comments` text,
  PRIMARY KEY (`tableID`),
  KEY `forelimbFK_idx` (`id`),
  CONSTRAINT `forelimbFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `forlimb_characters` VALUES (1,'1',1,5,2,1,5,3,2,5,3,4,6,3,1,6,1,5,1,51,2,1,3,NULL,'yes','yes','yes','no','yes','yes',NULL),(2,'2',1,5,2,1,5,3,2,5,3,4,6,3,1,6,1,5,1,51,2,1,3,NULL,'yes','yes','yes','no','yes','yes',NULL),(3,'4',1,5,2,1,5,3,2,5,3,4,6,3,1,6,1,5,1,51,2,1,3,NULL,'yes','yes','yes','no','yes','yes',NULL);
...
CREATE TABLE `habitat_preference` (
  ...
  PRIMARY KEY (`tableID`),
  KEY `habFK_idx` (`id`),
  CONSTRAINT `habFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `habitat_preference` VALUES (1,'10','SECFOREST',NULL,NULL,NULL),(2,'1','SECFOREST','AQUA',NULL,NULL),(3,'1',NULL,'SEMIARBORAL',NULL,NULL);
...
CREATE TABLE `head_characters` (
  ...
  PRIMARY KEY (`tableID`),
  KEY `headFK_idx` (`id`),
  CONSTRAINT `headFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `head_characters` VALUES (1,'1',1,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `hindlimb_characters` (
  ...
  `comments` text,
  PRIMARY KEY (`tableID`),
  KEY `hindlimbFK_idx` (`id`),
  CONSTRAINT `hindlimbFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hindlimb_characters` VALUES (1,'10',2,4,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'10',2,42,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'yes',NULL);
...
CREATE TABLE `misc` (
  ...
  PRIMARY KEY (`tableID`),
  KEY `MISCFK_idx` (`id`),
  CONSTRAINT `MISCFK` FOREIGN KEY (`id`) REFERENCES `taxonomic_identity` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `misc` VALUES (1,'1','VETEBRA',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2015-03-25 11:40:26
